...
response_brasilapi.status_code
data_brasilapi = response_brasilapi.json()

# 2. Transforme o resultado em DataFrame
df_brasilapi = pd.DataFrame(data_brasilapi)

# 3. Conte quantos bancos existem
quantidade_bancos = len(df_brasilapi)
print(quantidade_bancos)

# 4. Filtre bancos cujo nome contenha "Brasil".
df_bancos_brasil = df_brasilapi[df_brasilapi['name'].str.contains('Brasil', case=False, na=False)]
